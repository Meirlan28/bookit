...
@router.post("/rooms/{room_id}/bookings", response_model=BookingResponse, status_code=status.HTTP_201_CREATED)
async def create_booking(
    ...
    return await BookingService.create_booking(room_id, current_user.id, booking_data, db)
